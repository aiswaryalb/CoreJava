...
public class search extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        c1.getAccessibleContext().setAccessibleName("--select--");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            PreparedStatement ps=con.prepareStatement("select * from loginpage where uname=?");
            ps.setString(1, c);
            ResultSet r=ps.executeQuery();
            while(r.next())
            {
                 t1.setText(r.getString("uname"));
                t2.setText(r.getString("password"));
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            String n=t1.getText();
            String p=t2.getText();
            PreparedStatement ps=con.prepareStatement("update loginpage set uname=? ,password=? where uname=?");
            ps.setString(1,n);
            ps.setString(2, p);
            ps.setString(3, n);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            String c=(String) c1.getSelectedItem();
            PreparedStatement ps=con.prepareStatement("delete from loginpage where uname=?");
            ps.setString(1, c);
            int x=ps.executeUpdate();
            if (x>0) {
